...
<head>
    ...
    <title>Delete - <?= $reservation['lesson_id'] ?></title>
</head>
<body>
<h2>Delete - <?= $reservation['lesson_id'] ?></h2>
<form action="" method="post">
    <p>
        Weet u zeker dat u de reservation voor les "<?= $reservation['lesson_id'] ?>" wilt verwijderen?
    </p>
